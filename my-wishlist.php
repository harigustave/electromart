...
?>
				...
				<tr>
					<td class="col-md-2"><img src="admin/productimages/<?php echo htmlentities($row['pid']);?>/<?php echo htmlentities($row['pimage']);?>" alt="<?php echo htmlentities($row['pname']);?>" width="200"></td>
					<td class="col-md-6">
...
?>
						...
						<?php } ?>
						<div class="price"> 
							<?php echo htmlentities(number_format($row['pprice']));?> Rwf
							<span>
								<?php echo htmlentities(number_format($row['ppbeforediscount']));?> Rwf
							</span>
						</div>
					</td>
					<td class="col-md-2">
