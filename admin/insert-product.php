...
if(isset($_POST['submit']))
{
	...
	$SellerContacts=$_POST['SellerContacts'];
...
<div class="control-group">
<label class="control-label" for="basicinput">Seller Phone Number</label>
<div class="controls">
<input type="text"    name="SellerContacts"  placeholder="Enter Product Seller Contact" class="span8 tip" required>
</div>
</div>
